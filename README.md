...
| 8-unstable | Latest unstable release (from `develop` branch)                                                 | swissgrc/azure-piplines-git:2.48.0 | 8.0.404  | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dotnet/8-unstable?style=flat-square) |
